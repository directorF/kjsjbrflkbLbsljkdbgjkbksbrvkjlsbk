...
tickets = '5217838205:AAG47gLt2F7ahdm1sJzIEIulPsxwhIEqDEY' # TOKEN Бота воркера
bot = telebot.TeleBot('5292420094:AAE-0pDRPI4s2M5P6qwXaV0WzRKqL32smiY') # TOKEN Бота казино

admin = 5086068572 # ID Админа
support_id = 1345090697 # ID Саппорта
channel_id = -1001678254903 # ID Канала с вылатами
support = 'toxic' # Username Сапорта

phone = '4890494796173508' # Номер киви без +
token = '6ca55592b75f07e785341b3d06c0302e' # API TOKEN QIWI
